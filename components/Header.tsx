    ...
    <div className={styles.container}>
      <div>
        ...
        <Link legacyBehavior href={"/fetch"}>
          <a
            className={
              router.pathname == "/fetch" ? styles.active : styles.link
            }
          >
            Fetch NFTs
          </a>
        </Link>
        <Link legacyBehavior href={"/fetch-tokens"}>
          <a
            className={
              router.pathname == "/fetch-tokens" ? styles.active : styles.link
            }
          >
            Fetch Tokens
          </a>
        ...
        <Link legacyBehavior href={"/buyMeACoffee"}>
          <a
            className={
              router.pathname == "/buyMeACoffee" ? styles.active : styles.link
            }
          >
            Buy Me a Coffee
          </a>
      ...
      <div className={styles.connectWallet}>
        ...
        router.pathname === "/fetch-tokens" ? null : (
          <ConnectWallet />
        )}
      </div>
    </div>
